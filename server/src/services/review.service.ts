import { findApprovedReviewsByProduct, findApprovedReviews, findAllReviews, createReviewRecord, updateReviewStatus, deleteReviewRecord } from '../repositories/review.repository.js';
