...
export const wholesaleInquiries = mysqlTable('wholesale_inquiries', {
  ...
  volume: varchar('volume', { length: 128 }),
  notes: json('notes').$type<any[]>(),
  timeline: json('timeline').$type<any[]>(),
...
export const quotations = mysqlTable('quotations', {
  ...
  salesExecutive: varchar('sales_executive', { length: 255 }),
  discountType: mysqlEnum('discount_type', ['percentage', 'flat']).notNull().default('percentage'),
  ...
  payableAmount: decimal('payable_amount', { precision: 12, scale: 2 }).notNull().default('0'),
